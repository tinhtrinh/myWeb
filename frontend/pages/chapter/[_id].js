...
import ChapterAction from "../../components/chapter-action";
import ChapterBottomBar from "../../components/chapter-bottom-bar";
...
const Chapter = () => {
    ...
    if(!name) {
        ...
        return (
        <Layout>
            <ChapterAction backID={backID} nextID={nextID}/>
